...
if __name__ == '__main__':
        ...
        try:
            ...
            for epoch in range(num_epochs):
                ...
                if val_loss < best_val_loss:
                    ...
                    model_filename = 'models/ecgsmartnet_se_CAD_random_{}.pt'.format(current_time)
    ...
    # Save plot
    plot_path = f'models/ecgsmartnet_se_CAD_random_BEST_MODEL_{global_best_hyperparams["time"]}_curves.png'
