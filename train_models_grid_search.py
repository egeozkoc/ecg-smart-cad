...
if __name__ == '__main__':
            ...
            for bs in bss:
                for wd in wds:
                    ...
                    if best_val_loss < global_best_val_loss:
                        ...
                        global_best_model_path = 'models/ecgsmartnet_CAD_{}.pt'.format(current_time)
    ...
    # Save plot
    plot_path = f'models/ecgsmartnet_CAD_BEST_MODEL_{global_best_hyperparams["time"]}_curves.png'
